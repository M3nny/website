...
<nav class="flex flex-col md:flex-row flex-warp justify-evenly">
  {#if prev}
    ...
    >
      ...
      <div class="card-body">
        <span
          class="i-heroicons-outline-chevron-left opacity-50 group-hover:opacity-100 mr-auto"
        />
        <a
          rel="prev"
          href={prev.path}
  ...
  {#if next}
    ...
    >
      ...
      <div class="card-body">
        ...
        <span
          class="i-heroicons-outline-chevron-right opacity-50 group-hover:opacity-100 ml-auto"
        />
      </div>
    </div>
  {/if}
